...
public class commonControllerAdvice {
  @ExceptionHandler
  @ResponseBody
  protected ResponseEntity<String> handleNotFoundExeption(Exception ex) {
    logStackTrace(ex);
  ...
  @ExceptionHandler(DataExistExeption.class)
  @ResponseBody
  protected ResponseEntity<String> handlDataExistExeption(DataExistExeption ex) {
    logStackTrace(ex);
    return ResponseEntity
  ...
  private void logStackTrace(Exception ex) {
    ...
    if (Objects.nonNull(ex.getCause())) {
      stackTrace.append(ex.getCause().getMessage()).append(ApiConstants.ANSI_RED);
    }
